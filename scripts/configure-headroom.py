...
def desired_yaml(path: Path) -> dict:
    ...
    values = {
        ...
        "tool_loop_guardrails.hard_stop_after.idempotent_no_progress": 2,
        "tool_loop_guardrails.loop_caps.max_web_searches": 4,
        "tool_loop_guardrails.loop_caps.max_subagents": 1,
        "compression.protect_last_n": 6,
        "compression.proactive_prune_tokens": 24000,
        "compression.idle_compact_after_seconds": 600,
        ...
        "code_execution.max_tool_calls": 12,
    }
